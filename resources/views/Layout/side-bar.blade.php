<div id="docs-sidebar" class="docs-sidebar">
    ...
    <nav id="docs-nav" class="docs-nav navbar">
        <ul class="section-items list-unstyled nav flex-column pb-3">
            ...
            <li class="nav-item section-title"><a class="nav-link scrollto" href="#blueprint"><span class="theme-icon-holder me-2"><i class="fas fa-server"></i></span>Blueprint</a></li>
            ...
            <li class="nav-item section-title"><a class="nav-link scrollto" href="#content"><span class="theme-icon-holder me-2"><i class="fas fa-server"></i></span>Content</a></li>
            ...
            <li class="nav-item section-title"><a class="nav-link scrollto" href="#lanjutan"><span class="theme-icon-holder me-2"><i class="fas fa-server"></i></span>Lanjutan</a></li>
