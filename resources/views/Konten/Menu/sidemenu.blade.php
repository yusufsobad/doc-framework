<section class="docs-section" id="side-menu">
    ...
    <p>Setiap session user memiliki side menu masing-masing yang berbeda. Maka dari itu perlu beberapa konfigurasi</p>
        ...
        <div class="content">
            <ul>
                <p>Konfigurasi ini juga berupa array, maka dari itu perlu inisiasi array terlebih dahulu untuk menggunakannya. Terdapat 5 hal pada array, yaitu
                    ...
                    <li><b>label</b> digunakan untuk menampilkan label/nama side menu.</li>
                    <li><b>func</b> digunakan untuk memanggil function yang akan dijalankan.
                </p>
                </li>
