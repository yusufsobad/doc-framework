            ...
            <div class="content">
                <ul>
                    <p>Routing ini berbentuk array yang terdiri dari 3 hal yaitu home, view, dan page.
                        <br>
                        <li><b>namarouting</b> disesuaikan dengan role (jabatan), jika memakai hak akses login.</li>
                        ...
                        <li><b>page</b> digunakan untuk memanggil class yang akan dijalankan pada halaman ini.
                    </p>
                    </li>
                </ul>
            </div>
